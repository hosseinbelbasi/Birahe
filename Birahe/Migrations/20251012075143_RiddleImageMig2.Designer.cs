...
namespace Birahe.EndPoint.Migrations
{
    ...
    [Migration("20251012075143_RiddleImageMig2")]
    partial class RiddleImageMig2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Birahe.EndPoint.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 100,
                            Coin = 0,
                            CreationDateTime = new DateTime(2025, 10, 12, 11, 21, 42, 989, DateTimeKind.Local).AddTicks(2209),
                            IsBanned = false,
