...
namespace Birahe.EndPoint.Migrations
{
    ...
    [Migration("20251006120530_ContestItemMig")]
    partial class ContestItemMig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Birahe.EndPoint.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 100,
                            Coin = 0,
                            CreationDateTime = new DateTime(2025, 10, 6, 15, 35, 29, 645, DateTimeKind.Local).AddTicks(8647),
                            IsBanned = false,
