...
namespace Birahe.EndPoint.Migrations
{
    ...
    [Migration("20251006120852_ContestItmeMig2")]
    partial class ContestItmeMig2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Birahe.EndPoint.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 100,
                            Coin = 0,
                            CreationDateTime = new DateTime(2025, 10, 6, 15, 38, 52, 118, DateTimeKind.Local).AddTicks(9912),
                            IsBanned = false,
