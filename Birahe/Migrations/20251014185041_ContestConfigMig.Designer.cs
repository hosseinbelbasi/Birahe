...
namespace Birahe.EndPoint.Migrations
{
    ...
    [Migration("20251014185041_ContestConfigMig")]
    partial class ContestConfigMig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Birahe.EndPoint.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 100,
                            Coin = 0,
                            CreationDateTime = new DateTime(2025, 10, 14, 22, 20, 40, 190, DateTimeKind.Local).AddTicks(1612),
                            IsBanned = false,
