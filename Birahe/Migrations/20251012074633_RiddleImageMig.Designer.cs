...
namespace Birahe.EndPoint.Migrations
{
    ...
    [Migration("20251012074633_RiddleImageMig")]
    partial class RiddleImageMig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Birahe.EndPoint.Entities.Riddle", b =>
                {
                    ...
                    b.Property<string>("HintImagePath")
                        .HasMaxLength(500)
                    ...
                    b.Property<string>("RewardImagePath")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("Birahe.EndPoint.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 100,
                            Coin = 0,
                            CreationDateTime = new DateTime(2025, 10, 12, 11, 16, 32, 591, DateTimeKind.Local).AddTicks(3837),
                            IsBanned = false,
