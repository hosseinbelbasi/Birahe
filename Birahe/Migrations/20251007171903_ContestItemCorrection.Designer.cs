...
namespace Birahe.EndPoint.Migrations
{
    ...
    [Migration("20251007171903_ContestItemCorrection")]
    partial class ContestItemCorrection
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Birahe.EndPoint.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 100,
                            Coin = 0,
                            CreationDateTime = new DateTime(2025, 10, 7, 20, 49, 2, 53, DateTimeKind.Local).AddTicks(6726),
                            IsBanned = false,
