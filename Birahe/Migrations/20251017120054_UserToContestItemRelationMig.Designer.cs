...
namespace Birahe.EndPoint.Migrations
{
    ...
    [Migration("20251017120054_UserToContestItemRelationMig")]
    partial class UserToContestItemRelationMig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Birahe.EndPoint.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1000,
                            Coin = 0,
                            CreationDateTime = new DateTime(2025, 10, 17, 15, 30, 53, 826, DateTimeKind.Local).AddTicks(1358),
                            IsBanned = false,
