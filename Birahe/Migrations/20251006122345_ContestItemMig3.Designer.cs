...
namespace Birahe.EndPoint.Migrations
{
    ...
    [Migration("20251006122345_ContestItemMig3")]
    partial class ContestItemMig3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Birahe.EndPoint.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 100,
                            Coin = 0,
                            CreationDateTime = new DateTime(2025, 10, 6, 15, 53, 44, 791, DateTimeKind.Local).AddTicks(9080),
                            IsBanned = false,
