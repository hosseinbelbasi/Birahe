...
namespace Birahe.EndPoint.Migrations
{
    ...
    [Migration("20251005205912_UserBanMig")]
    partial class UserBanMig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Birahe.EndPoint.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 100,
                            Coin = 0,
                            CreationDateTime = new DateTime(2025, 10, 6, 0, 29, 11, 446, DateTimeKind.Local).AddTicks(4404),
                            IsBanned = false,
